    ...
    return (
        ...
        >
            ...
            >
                {genres?.map((g) => (
                    <button key={g._id}
                        className={`transition duration-300 ease-in-out hover:bg-gray-400 block p-2 rounded mb-[1rem] text-lg ${selectedGenre === g._id ? "bg-gray-200" : ""}`}
            ...
            <section
                className="flex flex-col justify-center items-center w-full mx-[8.5rem] lg:w-auto">
                <div
                    className="w-full lg:w-[100rem] mb-8">
                    <h1
                        className='mb-5'
                    >
                        Chosen For You
