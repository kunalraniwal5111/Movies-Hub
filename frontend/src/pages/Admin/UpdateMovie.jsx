...
const UpdateMovie = () => {
    ...
    const handleDeleteMovie = async () => {
        try {
            toast.success("Movue deleted successfully")
    ...
    return (
        <div
            className='container flex justify-center items-center mt-4'
        >
            <form>
                ...
                <div className="mb-4">
                    <label className="block">
                        Name:
                        <input type="text"
                            name='name' value={movieData.name}
                ...
                <div className="mb-4">
                    <label className="block">
                        Year:
                        <input type="number"
                            name='year' value={movieData.year}
                            onChange={handleChange}
                            className='border px-2 py-1 w-full'
                        />
                    </label>
                ...
                <div className="mb-4">
                    <label className="block">
                        ...
                        <input type="text"
                            name='cast' value={movieData.cast.join(", ")}
                ...
                <div className="mb-5">
                    <label style={!selectedImage ? {
                        ...
                        {/* input that accepts all images and takes a file input */}
