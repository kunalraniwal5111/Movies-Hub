...
const movieReview = async (req, res) => {
    try {
        ...
        if (movie) {
            // passing a callback function to find() function for checking if for any of the review that review's user is current user or not
...
const getNewMovies=async(req,res)=>{
    try {
        // giving latest movies and upto limit of 10 movies
